...
describe('.parse() statistical formulas', () => {
  ...
  it('AVEDEV', () => {
    ...
    expect(parser.parse('AVEDEV(1.1, 2)')).to.almost.eql({error: null, result: 0.45});
    expect(parser.parse('AVEDEV(1.1, 2, 5)')).to.almost.eql({error: null, result: 1.5333333333333332});
    expect(parser.parse('AVEDEV(1.1, 2, 5, 10)')).to.almost.eql({error: null, result: 2.975});
  });
  ...
  it('BETADIST', () => {
    ...
    expect(parser.parse('BETADIST(2, 8, 10, TRUE, 1, 3)')).to.almost.eql({error: null, result: 0.6854705810117458});
    expect(parser.parse('BETA.DIST(2, 8, 10, TRUE, 1, 3)')).to.almost.eql({error: null, result: 0.6854705810117458});
  });

  it('BETAINV', () => {
    expect(parser.parse('BETAINV()')).to.deep.equal({error: '#VALUE!', result: null});
    expect(parser.parse('BETAINV(0.6854705810117458, 8, 10, 1, 3)')).to.almost.eql({error: null, result: 2});
    expect(parser.parse('BETA.INV(0.6854705810117458, 8, 10, 1, 3)')).to.almost.eql({error: null, result: 2});
  });
  ...
  it('BINOMDIST', () => {
    ...
    expect(parser.parse('BINOMDIST(6, 10, 0.5, FALSE)')).to.almost.eql({error: null, result: 0.205078125});
    expect(parser.parse('BINOM.DIST(6, 10, 0.5, FALSE)')).to.almost.eql({error: null, result: 0.205078125});
  });
  ...
  it('BINOM.DIST.RANGE', () => {
    ...
    expect(parser.parse('BINOM.DIST.RANGE(60, 0.5, 34)')).to.almost.eql({error: null, result: 0.060616586840172675});
  });
  ...
  it('CHISQ.DIST', () => {
    ...
    expect(parser.parse('CHISQ.DIST(0.5, 1)')).to.almost.eql({error: null, result: 0.43939128946770356});
    expect(parser.parse('CHISQ.DIST(0.5, 1, TRUE)')).to.almost.eql({error: null, result: 0.5204998778130242});
  });
  ...
  it('CHISQ.DIST.RT', () => {
    ...
    expect(parser.parse('CHISQ.DIST.RT(3, 5)')).to.almost.eql({error: null, result: 0.6999858358786271});
  });
  ...
  it('CHISQ.INV', () => {
    ...
    expect(parser.parse('CHISQ.INV(0.5, 6)')).to.almost.eql({error: null, result: 5.348120627447116});
  });
  ...
  it('CHISQ.INV.RT', () => {
    ...
    expect(parser.parse('CHISQ.INV.RT(0.4, 6)')).to.almost.eql({error: null, result: 6.2107571945266935});
  });
  ...
  it('CONFIDENCE', () => {
    ...
    expect(parser.parse('CONFIDENCE(0.5, 1, 5)')).to.almost.eql({error: null, result: 0.301640986313058});
    expect(parser.parse('CONFIDENCE.NORM(0.5, 1, 5)')).to.almost.eql({error: null, result: 0.301640986313058});
  });
  ...
  it('CONFIDENCE.T', () => {
    ...
    expect(parser.parse('CONFIDENCE.T(0.5, 1, 5)')).to.almost.eql({error: null, result: 0.33124980616238564});
  });
  ...
  it('CORREL', () => {
    ...
    expect(parser.parse('CORREL(foo, bar)')).to.almost.eql({error: null, result: 0.9970544855015815});
  });
  ...
  it('COVARIANCE.S', () => {
    ...
    expect(parser.parse('COVARIANCE.S(foo, bar)')).to.almost.eql({error: null, result: 9.666666666});
  });
  ...
  it('FDIST', () => {
    ...
    expect(parser.parse('FDIST(15, 6, 4)')).to.almost.eql({error: null, result: 0.0012714469079329002});
    expect(parser.parse('FDIST(15, 6, 4, TRUE)')).to.almost.eql({error: null, result: 0.9897419523940192});
    expect(parser.parse('F.DIST(15, 6, 4, TRUE)')).to.almost.eql({error: null, result: 0.9897419523940192});
  });
  ...
  it('FDISTRT', () => {
    ...
    expect(parser.parse('FDISTRT(15, 6, 4)')).to.almost.eql({error: null, result: 0.010258047605980813});
    expect(parser.parse('F.DIST.RT(15, 6, 4)')).to.almost.eql({error: null, result: 0.010258047605980813});
  });
  ...
  it('FINV', () => {
    ...
    expect(parser.parse('FINV(0.1, 6, 4)')).to.almost.eql({error: null, result: 0.31438998832176834});
  ...
  it('FINVRT', () => {
    ...
    expect(parser.parse('FINVRT(0.1, 6, 4)')).to.almost.eql({error: null, result: 4.009749312673947});
    expect(parser.parse('F.INV.RT(0.1, 6, 4)')).to.almost.eql({error: null, result: 4.009749312673947});
  });

  it('FISHER', () => {
    expect(parser.parse('FISHER()')).to.deep.equal({error: '#VALUE!', result: null});
    expect(parser.parse('FISHER(0.1)')).to.almost.eql({error: null, result: 0.10033534773107562});
  ...
  it('FISHERINV', () => {
    ...
    expect(parser.parse('FISHERINV(0.1)')).to.almost.eql({error: null, result: 0.09966799462495583});
    expect(parser.parse('FISHERINV(1)')).to.almost.eql({error: null, result: 0.761594155955765});
  });
  ...
  it('FORECAST', () => {
    ...
    expect(parser.parse('FORECAST(30, foo, bar)')).to.almost.eql({error: null, result: 10.607253086419755});
  });
  ...
  it('GAMMA', () => {
    ...
    expect(parser.parse('GAMMA(0.1)')).to.almost.eql({error: null, result: 9.51350769866877});
  });
  ...
  it('GAMMADIST', () => {
    ...
    expect(parser.parse('GAMMADIST(1, 3, 7, TRUE)')).to.almost.eql({error: null, result: 0.00043670743091302124});
    expect(parser.parse('GAMMA.DIST(1, 3, 7, TRUE)')).to.almost.eql({error: null, result: 0.00043670743091302124});
  });
  ...
  it('GAMMAINV', () => {
    ...
    expect(parser.parse('GAMMAINV(1, 3, 7)')).to.almost.eql({error: null, result: 1233.435565298214});
    expect(parser.parse('GAMMA.INV(1, 3, 7)')).to.almost.eql({error: null, result: 1233.435565298214});
  });

  it('GAMMALN', () => {
    expect(parser.parse('GAMMALN()')).to.deep.equal({error: '#VALUE!', result: null});
    expect(parser.parse('GAMMALN(4)')).to.almost.eql({error: null, result: 1.7917594692280547});
  });

  it('GAMMALN.PRECISE', () => {
    expect(parser.parse('GAMMALN.PRECISE()')).to.deep.equal({error: '#N/A', result: null});
    expect(parser.parse('GAMMALN.PRECISE(4)')).to.almost.eql({error: null, result: 1.7917594692280547});
  });

  it('GAUSS', () => {
    expect(parser.parse('GAUSS()')).to.deep.equal({error: '#VALUE!', result: null});
    expect(parser.parse('GAUSS(4)')).to.almost.eql({error: null, result: 0.4999683287581669});
  });

  it('GEOMEAN', () => {
    parser.setVariable('foo', [4, 5, 8, 7, 11, 4, 3]);

    expect(parser.parse('GEOMEAN(foo)')).to.almost.eql({error: null, result: 5.476986969656962});
  });
  ...
  it('HARMEAN', () => {
    ...
    expect(parser.parse('HARMEAN(foo)')).to.almost.eql({error: null, result: 5.028375962061728});
  });
  ...
  it('HYPGEOMDIST', () => {
    ...
    expect(parser.parse('HYPGEOMDIST(1, 4, 8, 20)')).to.almost.eql({error: null, result: 0.3632610939112487});
    expect(parser.parse('HYPGEOMDIST(1, 4, 8, 20, TRUE)')).to.almost.eql({error: null, result: 0.46542827657378744});
  });
  ...
  it('INTERCEPT', () => {
    ...
    expect(parser.parse('INTERCEPT(foo, bar)')).to.almost.eql({error: null, result: 0.04838709677419217});
  });
  ...
  it('KURT', () => {
    ...
    expect(parser.parse('KURT(foo)')).to.almost.eql({error: null, result: -0.15179963720841627});
  ...
  it('LOGNORMDIST', () => {
    ...
    expect(parser.parse('LOGNORMDIST(4, 3.5, 1.2)')).to.almost.eql({error: null, result: 0.01761759668181924});
    expect(parser.parse('LOGNORMDIST(4, 3.5, 1.2, TRUE)')).to.almost.eql({error: null, result: 0.0390835557068005});
    expect(parser.parse('LOGNORM.DIST(4, 3.5, 1.2, TRUE)')).to.almost.eql({error: null, result: 0.0390835557068005});
  });
  ...
  it('LOGNORMINV', () => {
    ...
    expect(parser.parse('LOGNORMINV(0.0390835557068005, 3.5, 1.2)')).to.almost.eql({error: null, result: 4});
    expect(parser.parse('LOGNORM.INV(0.0390835557068005, 3.5, 1.2)')).to.almost.eql({error: null, result: 4});
  });
  ...
  it('NEGBINOMDIST', () => {
    ...
    expect(parser.parse('NEGBINOMDIST(10, 5, 0.25)')).to.almost.eql({error: null, result: 0.05504866037517786});
    expect(parser.parse('NEGBINOMDIST(10, 5, 0.25, TRUE)')).to.almost.eql({error: null, result: 0.3135140584781766});
    expect(parser.parse('NEGBINOM.DIST(10, 5, 0.25, TRUE)')).to.almost.eql({error: null, result: 0.3135140584781766});
  });
  ...
  it('NORMDIST', () => {
    ...
    expect(parser.parse('NORMDIST(1, 0, 1)')).to.almost.eql({error: null, result: 0.24197072451914337});
    expect(parser.parse('NORMDIST(1, 0, 1, TRUE)')).to.almost.eql({error: null, result: 0.8413447460685429});
    expect(parser.parse('NORM.DIST(1, 0, 1, TRUE)')).to.almost.eql({error: null, result: 0.8413447460685429});
  });
  ...
  it('NORMINV', () => {
    ...
    expect(parser.parse('NORMINV(1, 0, 1)')).to.almost.eql({error: null, result: 141.4213562373095});
    expect(parser.parse('NORM.INV(1, 0, 1)')).to.almost.eql({error: null, result: 141.4213562373095});
  });

  it('NORMSDIST', () => {
    expect(parser.parse('NORMSDIST()')).to.deep.equal({error: '#VALUE!', result: null});
    expect(parser.parse('NORMSDIST(1)')).to.almost.eql({error: null, result: 0.24197072451914337});
    expect(parser.parse('NORMSDIST(1, TRUE)')).to.almost.eql({error: null, result: 0.8413447460685429});
    expect(parser.parse('NORM.S.DIST(1, TRUE)')).to.almost.eql({error: null, result: 0.8413447460685429});
  });

  it('NORMSINV', () => {
    expect(parser.parse('NORMSINV()')).to.deep.equal({error: '#VALUE!', result: null});
    expect(parser.parse('NORMSINV(1)')).to.almost.eql({error: null, result: 141.4213562373095});
    expect(parser.parse('NORM.S.INV(1)')).to.almost.eql({error: null, result: 141.4213562373095});
  });
  ...
  it('PEARSON', () => {
    ...
    expect(parser.parse('PEARSON(foo, bar)')).to.almost.eql({error: null, result: 0.6993786061802354});
  ...
  it('PHI', () => {
    ...
    expect(parser.parse('PHI(1)')).to.almost.eql({error: null, result: 0.24197072451914337});
  });
  ...
  it('POISSONDIST', () => {
    ...
    expect(parser.parse('POISSONDIST(1, 3)')).to.almost.eql({error: null, result: 0.14936120510359185});
    expect(parser.parse('POISSONDIST(1, 3, TRUE)')).to.almost.eql({error: null, result: 0.1991482734714558});
    expect(parser.parse('POISSON.DIST(1, 3, TRUE)')).to.almost.eql({error: null, result: 0.1991482734714558});
  });
  ...
  it('RSQ', () => {
    ...
    expect(parser.parse('RSQ(foo, bar)')).to.almost.eql({error: null, result: 0.05795019157088122});
  ...
  it('SKEW', () => {
    ...
    expect(parser.parse('SKEW(foo)')).to.almost.eql({error: null, result: 0.3595430714067974});
  ...
  it('SKEWP', () => {
    ...
    expect(parser.parse('SKEWP(foo)')).to.almost.eql({error: null, result: 0.303193339354144});
    expect(parser.parse('SKEW.P(foo)')).to.almost.eql({error: null, result: 0.303193339354144});
  ...
  it('SLOPE', () => {
    ...
    expect(parser.parse('SLOPE(foo, bar)')).to.almost.eql({error: null, result: 0.3055555555555556});
  ...
  it('STDEVP', () => {
    ...
    expect(parser.parse('STDEVP(foo)')).to.almost.eql({error: null, result: 26.054558142482477});
    expect(parser.parse('STDEV.P(foo)')).to.almost.eql({error: null, result: 26.054558142482477});
  });

  it('STDEVS', () => {
    parser.setVariable('foo', [1345, 1301, 1368, 1322, 1310, 1370, 1318, 1350, 1303, 1299]);

    expect(parser.parse('STDEVS(foo)')).to.almost.eql({error: null, result: 27.46391571984349});
    expect(parser.parse('STDEV.S(foo)')).to.almost.eql({error: null, result: 27.46391571984349});
  });

  it('STDEVA', () => {
    parser.setVariable('foo', [1345, 1301, 1368, 1322, 1310, 1370, 1318, 1350, 1303, 1299]);

    expect(parser.parse('STDEVA(foo)')).to.almost.eql({error: null, result: 27.46391571984349});
  });

  it('STDEVPA', () => {
    parser.setVariable('foo', [1345, 1301, 1368, 1322, 1310, 1370, 1318, 1350, 1303, 1299]);

    expect(parser.parse('STDEVPA(foo)')).to.almost.eql({error: null, result: 26.054558142482477});
  });
  ...
  it('STEYX', () => {
    ...
    expect(parser.parse('STEYX(foo, bar)')).to.almost.eql({error: null, result: 3.305718950210041});
  ...
  it('TDIST', () => {
    ...
    expect(parser.parse('TDIST(1, 3)')).to.almost.eql({error: null, result: 0.2067483346226397});
    expect(parser.parse('TDIST(1, 3, TRUE)')).to.almost.eql({error: null, result: 0.8044988904727264});
    expect(parser.parse('T.DIST(1, 3, TRUE)')).to.almost.eql({error: null, result: 0.8044988904727264});
  });
  ...
  it('T.DIST.2T', () => {
    ...
    expect(parser.parse('T.DIST.2T(1, 6)')).to.almost.eql({error: null, result: 0.3559176837495821});
  });
  ...
  it('T.DIST.RT', () => {
    ...
    expect(parser.parse('T.DIST.RT(1, 6)')).to.almost.eql({error: null, result: 0.17795884187479105});
  });
  ...
  it('TINV', () => {
    ...
    expect(parser.parse('TINV(0.1, 6)')).to.almost.eql({error: null, result: -1.4397557472652736});
    expect(parser.parse('T.INV(0.1, 6)')).to.almost.eql({error: null, result: -1.4397557472652736});
  });
  ...
  it('T.INV.2T', () => {
    ...
    expect(parser.parse('T.INV.2T(0.1, 6)')).to.almost.eql({error: null, result: 1.9431802743487372});
  });
  ...
  it('TRIMMEAN', () => {
    ...
    expect(parser.parse('TRIMMEAN(foo, 0.2)')).to.almost.eql({error: null, result: 3.777777777777});
  ...
  it('VARP', () => {
    ...
    expect(parser.parse('VARP(1, 2, 3, 4)')).to.almost.eql({error: null, result: 1.25});
    expect(parser.parse('VAR.P(1, 2, 3, 4)')).to.almost.eql({error: null, result: 1.25});
  });

  it('VARS', () => {
    expect(parser.parse('VARS()')).to.deep.equal({error: null, result: -0});
    expect(parser.parse('VARS(1)')).to.deep.equal({error: null, result: NaN});
    expect(parser.parse('VARS(1, 2)')).to.almost.eql({error: null, result: 0.5});
    expect(parser.parse('VARS(1, 2, 3)')).to.almost.eql({error: null, result: 1});
    expect(parser.parse('VARS(1, 2, 3, 4)')).to.almost.eql({error: null, result: 1.6666666666666});
    expect(parser.parse('VAR.S(1, 2, 3, 4)')).to.almost.eql({error: null, result: 1.6666666666666});
    expect(parser.parse('VAR.S(1, 2, 3, 4, TRUE, "foo")')).to.almost.eql({error: null, result: 1.66666666666});
  });

  it('VARA', () => {
    expect(parser.parse('VARA()')).to.deep.equal({error: null, result: -0});
    expect(parser.parse('VARA(1)')).to.deep.equal({error: null, result: NaN});
    expect(parser.parse('VARA(1, 2)')).to.almost.eql({error: null, result: 0.5});
    expect(parser.parse('VARA(1, 2, 3)')).to.almost.eql({error: null, result: 1});
    expect(parser.parse('VARA(1, 2, 3, 4)')).to.almost.eql({error: null, result: 1.666666666666});
    expect(parser.parse('VARA(1, 2, 3, 4, TRUE, "foo")')).to.almost.eql({error: null, result: 2.166666666666});
  });
  ...
  it('VARPA', () => {
    ...
    expect(parser.parse('VARPA(1, 2, 3, 4)')).to.almost.eql({error: null, result: 1.25});
    expect(parser.parse('VARPA(1, 2, 3, 4, TRUE, "foo")')).to.almost.eql({error: null, result: 1.80555555555});
  });
  ...
  it('WEIBULLDIST', () => {
    ...
    expect(parser.parse('WEIBULLDIST(1, 2, 3)')).to.almost.eql({error: null, result: 0.1988531815143044});
    expect(parser.parse('WEIBULLDIST(1, 2, 3, TRUE)')).to.almost.eql({error: null, result: 0.10516068318563021});
    expect(parser.parse('WEIBULL.DIST(1, 2, 3, TRUE)')).to.almost.eql({error: null, result: 0.10516068318563021});
  });
});
